...
{
    _imageUrl = imageUrl;
    [_adView sd_setImageWithURL:[NSURL URLWithString:_imageUrl]];
}
...
- (void)dismiss
{
    [UIView animateWithDuration:0.3f animations:^{
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"ADDismiss" object:nil];
    }];
